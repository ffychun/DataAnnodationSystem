...
function _via_util_file_select_local(type, handler, multiple) {
  ...
  fsel.setAttribute('id','project-select');
...
// function _via_util_page_process_action1(id) {
//   var action_map = {
//     'via_page_fileuri_button_bulk_add':_via_control_panel._page_on_action_fileuri_bulk_add,
//   }
//   _via_page_action_map = action_map;
//   for ( var action_id in _via_page_action_map ) {
//     if (id === action_id ) {
//       _via_page_current = document.getElementById('via_page_container').getElementsByClassName('via_page')[1];
//       var page_data = _via_util_page_gather_user_input();
//       page_data['_action_id'] = id;
//       _via_page_action_map[action_id].call(_via_control_panel,page_data);
//       //_via_util_page_hide();
//     }
//   }
// }
